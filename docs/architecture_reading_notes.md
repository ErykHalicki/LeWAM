...
- dream zero
    ...
    - since the architecture is singular (no seperate IDM or planner or anything) there is just 1 training phase with optional post training on specific tasks. 
- dreamer v3 (and other latent space models?)
- LeWorldModel 
    - pretty much just VJEPA2-AC with sigreg
    - still uses infernce time planning using MPC, not policy learning
