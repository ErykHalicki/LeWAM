...
Usage:
    python src/wam/training/scripts/null_baseline.py --config configs/train/default.yaml
    python src/wam/training/scripts/null_baseline.py --config configs/train/default.yaml --samples 500
"""
import os
import argparse
import random
...
from wam.models.action_encoders import ActionPreprocessor
...
def main():
    ...
    preprocessor = ActionPreprocessor(norm_stats_path, norm_strategy).to(device)
